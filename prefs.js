...
class PrefsWidget {
    ...
    adjustBlur() {
        ...
        this.resetBlurButton.connect('clicked', () => {
            ...
            this.blur_scale.set_value(this._settings.get_int('sigma'));
        });

        this.blur_scale.set_value(this._settings.get_int('sigma'));
        this.blur_scale.connect('value-changed', entry => {
            this._settings.set_int('sigma', entry.get_value());
        });
    ...
    adjustBrightness() {
        ...
        this.resetBrightnessButton.connect('clicked', () => {
            ...
            this.brightness_scale.set_value(this._settings.get_double('brightness'));
        });

        this.brightness_scale.set_value(this._settings.get_double('brightness'));
        this.brightness_scale.connect('value-changed', entry => {
            this._settings.set_double('brightness', entry.get_value());
        });
